...
void Cell6Run(Cell6* me) {
    ...
    enum Cell6States state_u = me->state;
    double v_u = me->v;
    ...
    switch(me->state) {
        case CELL6_RP: // Logic for state RP
            if(me->g >= 44.5) {
            ...
            break;
        case CELL6_ST: // Logic for state ST
            if(me->g <= 0 && me->v < 44.5) {
                // Next state is RRP
                state_u = CELL6_RRP;
            }
            ...
            break;
        case CELL6_UP: // Logic for state UP
            ...
            break;
        case CELL6_ERP: // Logic for state ERP
            if(me->v <= 30) {
                t_u = 0;
            ...
            break;
        case CELL6_RRP: // Logic for state RRP
            if(me->g >= 44.5) {
                theta_u = 9.988E-4 / me->t;
