...
void Cell14Run(Cell14* me) {
    ...
    enum Cell14States state_u = me->state;
    double v_u = me->v;
    ...
    switch(me->state) {
        case CELL14_RP: // Logic for state RP
            if(me->g >= 44.5) {
            ...
            break;
        case CELL14_ST: // Logic for state ST
            ...
            break;
        case CELL14_UP: // Logic for state UP
            ...
            break;
        case CELL14_ERP: // Logic for state ERP
            if(me->v <= 30.0) {
                t_u = 0.0;
            ...
            break;
        case CELL14_RRP: // Logic for state RRP
            if(me->g >= 44.5) {
                theta_u = 9.988E-4 / me->t;
