...
void Cell9Run(Cell9* me) {
    ...
    enum Cell9States state_u = me->state;
    double v_u = me->v;
    ...
    switch(me->state) {
        case CELL9_RP: // Logic for state RP
            if(me->g >= 44.5) {
            ...
            break;
        case CELL9_ST: // Logic for state ST
            ...
            break;
        case CELL9_UP: // Logic for state UP
            ...
            break;
        case CELL9_ERP: // Logic for state ERP
            if(me->v <= 30.0) {
                t_u = 0.0;
            ...
            break;
        case CELL9_RRP: // Logic for state RRP
            if(me->g >= 44.5) {
                theta_u = 9.988E-4 / me->t;
