...
void Cell24Run(Cell24* me) {
    ...
    enum Cell24States state_u = me->state;
    double v_u = me->v;
    ...
    switch(me->state) {
        case CELL24_RP: // Logic for state RP
            if(me->g >= 44.5) {
            ...
            break;
        case CELL24_ST: // Logic for state ST
            ...
            break;
        case CELL24_UP: // Logic for state UP
            ...
            break;
        case CELL24_ERP: // Logic for state ERP
            if(me->v <= 30.0) {
                t_u = 0.0;
            ...
            break;
        case CELL24_RRP: // Logic for state RRP
            if(me->g >= 44.5) {
                theta_u = 9.988E-4 / me->t;
